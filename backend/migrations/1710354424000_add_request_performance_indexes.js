...
exports.down = (pgm) => {
  pgm.sql(
    "DROP INDEX IF EXISTS public.idx_shopify_tokens_store_updated_at;",
  );
  pgm.sql(
    "DROP INDEX IF EXISTS public.idx_shopify_tokens_user_store_updated_at;",
  );
  pgm.sql("DROP INDEX IF EXISTS public.idx_user_stores_user_id;");
  pgm.sql("DROP INDEX IF EXISTS public.idx_permissions_user_id;");
  pgm.sql("DROP INDEX IF EXISTS public.idx_customers_user_created_at;");
  pgm.sql("DROP INDEX IF EXISTS public.idx_customers_store_created_at;");
  pgm.sql("DROP INDEX IF EXISTS public.idx_orders_user_created_at;");
  pgm.sql("DROP INDEX IF EXISTS public.idx_orders_store_created_at;");
  pgm.sql("DROP INDEX IF EXISTS public.idx_products_user_updated_at;");
  pgm.sql("DROP INDEX IF EXISTS public.idx_products_store_updated_at;");
};
