...
const PERMISSION_COPY = {
  ar: {
    ...
    descriptions: {
      ...
      can_edit_orders:
        "يسمح بتعديل تفاصيل الأوردر بالكامل، ويشمل الحالة والدفع والتنفيذ أو restock وتعديلات الهاتف والعنوان والمتابعة الداخلية، ويضمن أيضًا فتح شاشات الطلبات وتفاصيلها.",
      can_view_customers:
  ...
  en: {
    ...
    descriptions: {
      ...
      can_edit_orders:
        "Allows full order editing across order details, including status, payment method, fulfillment or restock, contact/address overrides, and internal notes. It also guarantees access to order views.",
      can_view_customers:
